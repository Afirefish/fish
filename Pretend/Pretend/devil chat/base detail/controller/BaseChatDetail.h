...
@property (strong, nonatomic) BaseChatControlsView *controlsView; // 控制视图
@property (assign, nonatomic) BOOL isAutoPlaying;// 自动
@property (assign, nonatomic) BOOL isfastPlaying; // 快进
